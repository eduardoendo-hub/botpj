...
def _build_system_prompt(
    ...
    parts.append(
        ...
        "\n  4. Curso ou tema de interesse"
        "\n  5. Número de alunos"
        "\n  6. Modalidade (presencial / online ao vivo / EAD / in company)"
        "\n  7. Prazo desejado"
        "\n  8. CNPJ — peça SOMENTE ao fechar o atendimento, junto com a confirmação final dos dados para a proposta."
        "\n\nREGRAS DE ESCALAÇÃO — siga rigorosamente:"
        "\n• TRILHA A (turma aberta, 1-3 pessoas): NUNCA transfira para consultor. Informe como se inscrever e indique o site."
        "\n• TRILHA B (equipe/empresa/in company): colete nome, empresa, curso, número de alunos e modalidade. CNPJ só no momento de fechar os dados para proposta. Após coletar tudo, use EXATAMENTE: 'em breve um consultor entrará em contato para montar a proposta'."
